...
When you put this in the software.dat file it will install soap,mysqli and gd php extensions using port 9176. This will install php using apt-get which means you are free to customise the method of installation if you want to

>     PHP:soap:mysqli:gd|9176

When you put this in the software.dat file it will install pgsql,curl,zip and gd  php extensions using port 9176 using a socket file to communicate. This will install php using apt-get.
...
>     DATASTOREMOUNTTOOL:rclone:script if you want to install rclone as your datastore mount tool
...
>     DATASTORETOOL:rclone:repo
>     DATASTORETOOL:rclone:script
>     DATASTORETOOL:rclone:binary
>     DATASTORETOOL:rclone:source
