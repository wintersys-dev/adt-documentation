...
7. A VPC (adt-vpc) with subnet range 10.0.1.0/24 for the london region
...
9. The [StackScript](https://cloud.linode.com/stackscripts/635271) configured with the values obtained in steps 1 to 8
