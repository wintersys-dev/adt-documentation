...
>     ${BUILD_HOME}/services/server/cloud-init/${CLOUDHOST}/authenticator.yaml
>     ${BUILD_HOME}/services/server/cloud-init/${CLOUDHOST}/autoscaler.yaml
>     ${BUILD_HOME}/services/server/cloud-init/${CLOUDHOST}/webserver.yaml
>     ${BUILD_HOME}/services/server/cloud-init/${CLOUDHOST}/database.yaml
...
>     ${BUILD_HOME}/services/server/CreateServer.sh
...
>     ${HOME}/services/server/cloud-init/${CLOUDHOST}/webserver.yaml
...
>     ${HOME}/services/server/CreateServer.sh
