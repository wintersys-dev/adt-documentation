The technique I use is to have "base" configurations for the webserver I am deploying. What this means is that I could have a "library" of configurations stored in my forked webserver repository for different application types that I might want to deploy. I could have configurations that are optimised for high traffic, I could have configurations that are optimised for maximum security and I could have configurations that have additional featues such as if I want to install some sort of monitoring tool during testing and so on. So, each of these configurations are stored in the directory structure made distinct by application type and webserver type. The structure of the directory system is as follows:


>     ${HOME}/services/webserver/configuration/joomla/apache/online/source
>     ${HOME}/services/webserver/configuration/joomla/apache/online/repo
>     ${HOME}/services/webserver/configuration/joomla/nginx/online/source
>     ${HOME}/services/webserver/configuration/joomla/nginx/online/repo
>     ${HOME}/services/webserver/configuration/joomla/lighttpd/online/source
>     ${HOME}/services/webserver/configuration/joomla/lighttpd/online/repo
>
>     ${HOME}/services/webserver/configuration/wordpress/apache/online/source
>     ${HOME}/services/webserver/configuration/wordpress/apache/online/repo
>     ${HOME}/services/webserver/configuration/wordpress/nginx/online/source
>     ${HOME}/services/webserver/configuration/wordpress/nginx/online/repo
>     ${HOME}/services/webserver/configuration/wordpress/lighttpd/online/source
>     ${HOME}/services/webserver/configuration/wordpress/lighttpd/online/repo
