...
>     <website_url>-firewall-emailed-links                      (these are the short lived unique links that configs can be installed from)
...
>     <website_url>-whitelist-emailed-links                      (these are the short lived unique links that configs can be installed from)
...
>     <website_url>-wireguard-emailed-links                      (these are the short lived unique links that configs can be installed from)
