...
>      ${HOME}/services/datastore/configwrapper/
...
>     ${HOME}/services/datastore/configwrapper/CheckConfigDatastore.sh
>     ${HOME}/services/datastore/configwrapper/DeleteFromConfigDatastore.sh
>     ${HOME}/services/datastore/configwrapper/GetDBCredential.sh
>     ${HOME}/services/datastore/configwrapper/DeleteFromConfigDatastore.sh
>     ${HOME}/services/datastore/configwrapper/GetFromConfigDatastore.sh
>     ${HOME}/services/datastore/configwrapper/ListFromConfigDatastore.sh
>     ${HOME}/services/datastore/configwrapper/PutToConfigDatastore.sh
...
>     ${HOME}/utilities/processing/ManuallyScale.sh <no_webservers>
...
Cron is used to schedule system processes on all machines and there is a defined process for [application development workflow](https://github.com/wintersys-dev/adt-build-machine-scripts/blob/master/doco/AgileToolkitDeployment/ApplicatonWorkflow.md) starting in development mode and working up towards full production deployments with multiple webservers.
